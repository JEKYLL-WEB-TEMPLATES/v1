...
$.fn.leavePage = function() { 	
	...
	this.click(function(event){
		...
		$('#designer-img').animate({'opacity':'0', 'left':'-92px'}, 500, 'easeOutExpo');
		$('#coder-img').animate({'opacity':'0', 'right':'-92px'}, 500, 'easeOutExpo');
		$('#nav').animate({'opacity':'0', 'top':'-92px'}, 500, 'easeOutExpo');
		$('#home_nav a').animate({'opacity':'0', 'bottom':'-92px'}, 500, 'easeOutExpo');
...
function animateFace() {
	...
	section.mouseenter(function(e){
		...
		loop = setInterval(function(){
			...
			designerImg.css({width:420 + (520 - xp) * 0.62, left: 100 + (520 - xp) * 0.1});
		    coderImg.css({width:420 + (xp - 520) * 0.62, right: 100 - (520 - xp) * 0.1});

		    designerBg.css({left: 100 + (520 - xp) * 0.062, opacity: ((1040 - xp)/520)});
		    coderBg.css({right:  100 + (xp - 520) * 0.062, opacity: (xp/520)});
